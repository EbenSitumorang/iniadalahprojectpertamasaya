...
<html>
<head>
<title>Flowers & Co. - Checkout</title>
<!-- for-mobile-apps -->
	...
	<div class="logo_products">
		...
		<div class="w3ls_logo_products_left1">
				<ul class="phone_email">
					<li><i class="fa fa-phone" aria-hidden="true"></i>Hubungi Kami : (+6282) 29833 8359</li>
				</ul>
			</div>
			<div class="w3ls_logo_products_left">
				<h1><a href="index.php">Flower & Co.</a></h1>
			</div>
...
<!-- checkout -->
	<div class="checkout">
		<div class="container">
			<h1>Terima kasih, <?=$_SESSION['name']?> telah membeli <?php echo $itungtrans3 ?> barang di Flowers & Co.</span></h1>
...
<div class="footer">
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Eben situmorang, Medan.</li>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:info@email">ebensitumorang8@gmail.co</a></li>
						<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>+62 822 98338359</li>
					</ul>
				</div>
				<div class="col-md-3 w3_footer_grid">
					<h3>Tentang Kami</h3>
					<ul class="info"> 
						<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="about.html">Tenteng Kami</a></li>
						<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="about.html">Bagaimana Caranya</a></li>
		...
		<div class="footer-copy">
			...
			<div class="container">
				<p>© 2024 By Eben Situmorang. All rights reserved</p>
			</div>
		</div>

...
<html>
<head>
<title>Flowers & Co.- Keranjang Saya</title>
<!-- for-mobile-apps -->
			...
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						...
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:info@email">ebensitumorangn8@gmail.com</a></li>

...
<html>
<head>
<title>Flowers & Co. - Pencarian</title>
<!-- for-mobile-apps -->
	...
	<div class="logo_products">
		...
		<div class="w3ls_logo_products_left1">
			...
			<div class="w3ls_logo_products_left">
				<h1><a href="index.php">Flowers & Co.</a></h1>
			</div>
...
<div class="footer">
			...
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						...
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:info@email">ebensitumorang8@gmail.com</a></li>
						<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>+62 822 9833 8359</li>
					</ul>
				</div>
				<div class="col-md-3 w3_footer_grid">
					<h3>Tentang Kami</h3>
					<ul class="info"> 
						<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="about.html">Tentang</a></li>
		...
		<div class="footer-copy">
			...
			<div class="container">
				<p>© 2024 Eben situmorang. All rights reserved</p>
			</div>
		</div>
